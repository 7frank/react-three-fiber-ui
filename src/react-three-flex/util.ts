  ...
  return Object.keys(props).forEach((name) => {
    ...
    if (typeof value === "string") {
      switch (name) {
        ...
        case "dir":
        case "flexDirection":
          return node.setFlexDirection(
            // @ts-ignore
            Yoga[`FLEX_DIRECTION_${jsxPropToYogaProp(value)}`]
          );
        case "align":
        case "alignItems":
          // @ts-ignore
        ...
        case "justify":
        case "justifyContent":
          return node.setJustifyContent(
            // @ts-ignore
            Yoga[`JUSTIFY_${jsxPropToYogaProp(value)}`]
          );
        case "wrap":
        case "flexWrap":
          // @ts-ignore
